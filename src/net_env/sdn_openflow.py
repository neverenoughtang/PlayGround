...
class SDNStarTopo(NetworkEnvBase):
    ...
    def __init__(self, lab_name="sdn_openflow"):
        ...
        # 主机 (Hosts)
        self.h1 = self.lab.add_node("h1", self.lab.images["new_ubuntu"], x=200, y=650)
        self.h2 = self.lab.add_node("h2", self.lab.images["new_ubuntu"], x=400, y=650)
        self.h3 = self.lab.add_node("h3", self.lab.images["new_ubuntu"], x=600, y=650)
