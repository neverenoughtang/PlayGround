...
class P4StarTopo(NetworkEnvBase):
    ...
    def __init__(self, lab_name="p4_star"):
        ...
        self.h1 = self.lab.add_node("h1", self.lab.images["new_ubuntu"], x=200, y=100)
        self.h2 = self.lab.add_node("h2", self.lab.images["new_ubuntu"], x=600, y=100)
        self.h3 = self.lab.add_node("h3", self.lab.images["new_ubuntu"], x=200, y=500)
        self.h4 = self.lab.add_node("h4", self.lab.images["new_ubuntu"], x=600, y=500)
