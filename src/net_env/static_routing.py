...
class StaticRouting(NetworkEnvBase):
    ...
    def __init__(self, lab_name="static_routing"):
        ...
        # S1 -> 2 hosts
        h1 = self.lab.add_node("h1", self.lab.images["new_ubuntu"], x=50, y=400)
        h2 = self.lab.add_node("h2", self.lab.images["new_ubuntu"], x=150, y=400)
        
        # S2 -> 1 host
        h3 = self.lab.add_node("h3", self.lab.images["new_ubuntu"], x=300, y=400)
        
        # S3 -> 1 hosts
        h4 = self.lab.add_node("h4", self.lab.images["new_ubuntu"], x=600, y=400)

        # S4 -> 2 hosts
        h5 = self.lab.add_node("h5", self.lab.images["new_ubuntu"], x=700, y=400)
        h6 = self.lab.add_node("h6", self.lab.images["new_ubuntu"], x=800, y=400)
